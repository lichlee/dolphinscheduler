...
public final class Constants {
     ...
     */
    public static final String JAVA_SECURITY_AUTH_LOGIN_CONFIG_PATH = "java.security.auth.login.config.path";
     ...
     * param key auth
     */
    public static final String HIVE_JDBC_AUTH_KEY = "auth";
}
